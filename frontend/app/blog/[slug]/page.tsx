    ...
    useEffect(() => {
        const loadPost = async () => {
            try {
                ...
                // Fetch claps and comments for this post
                try {
                    ...
                    // Fetch claps
                    const clapRes = await fetch(`${base}/posts/${data.slug}/claps`);
                    if (clapRes.ok) {
                    ...
                    const commentsRes = await fetch(`${base}/posts/${data.slug}/comments`);
                    if (commentsRes.ok) {
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:site_name" content="BetaDomot" />
                ...
                <meta name="twitter:creator" content="@betadomot" />
            </Head>
            <Header />
